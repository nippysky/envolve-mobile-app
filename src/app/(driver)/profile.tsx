  ...
  return (
    ...
    >
      <View style={styles.avatarSection}>
        ...
        <View style={[styles.rolePill, { backgroundColor: Colors.cyan + '20' }]}>
          <Text style={[styles.roleText, { color: Colors.cyan }]}>Driver</Text>
        </View>
      </View>

      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Navigation</Text>
        <MenuRow icon="🚴" label="Active Deliveries" onPress={() => router.push('/(driver)/deliveries')} />
        <MenuRow icon="📅" label="Delivery History"  onPress={() => router.push('/(driver)/history')} />
      </View>
